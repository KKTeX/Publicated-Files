% 東大理科解答用紙をtikzで再現
%
%   lualatex -interaction=nonstopmode -halt-on-error qiita-todai-rika-answer-sheet.tex
%
...
%% ファイルを書き換えずに作る場合：
%%   lualatex -jobname=qiita-todai-rika-answer-sheet-a4 "\newcommand\TDpaper{a4}\input{qiita-todai-rika-answer-sheet}"
